...
if store.present?
  ...
  Spree::Page.create(slug: '/factory/structure', title: 'Структура предприятия', body: 'Структура предприятия', store_ids: [store_id])
  Spree::Page.create(slug: '/factory/certificates', title: 'Сертификаты и награды', body: 'Сертификаты и награды', store_ids: [store_id])
  Spree::Page.create(slug: '/factory/partners', title: 'Партнеры', body: 'Партнеры', store_ids: [store_id])
  Spree::Page.create(slug: '/factory/vacancies', title: 'Вакансии', body: 'Вакансии', store_ids: [store_id])
  Spree::Page.create(slug: '/factory/documents', title: 'Документы', body: 'Документы', store_ids: [store_id])
  ...
  Spree::Page.create(slug: '/contact/requisites', title: 'Реквизиты', body: 'Реквизиты', store_ids: [store_id])
  Spree::Page.create(slug: '/contact/feedback', title: 'Обратная связь', body: 'Обратная связь', store_ids: [store_id])
  Spree::Page.create(slug: '/contact/request-call', title: 'Заказать звонок', body: 'Заказать звонок', store_ids: [store_id])
end
